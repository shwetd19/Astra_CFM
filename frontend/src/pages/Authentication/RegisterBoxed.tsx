...
const RegisterBoxed = () => {
    ...
    const sendDataToBackend = async (data: any) => {
        try {
            const response: AxiosResponse<any> = await axios.post('http://localhost:5000/signup', data);
    ...
    <div>
        ...
        <input type="text" id="fullName" placeholder="Enter Full Name *" className="form-input" />
    </div>
    <div>
    ...
    <div>
        <label htmlFor="workingPlace">Ordinary Place Of Working *</label>
        <select
        id="workingPlace"
        className="form-input"
